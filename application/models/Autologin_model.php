...
class Autologin_model extends CI_Model {
    ...
    public function update($user, $series, $private) {
        ...
        return $this->db->update($this->table, array('keylogin' => $private, 'created' => time()));
    }
    ...
    public function insert($user, $series, $private) {
        return $this->db->insert($this->table, array('user' => $user, 'series' => $series, 'keylogin' => $private, 'created' => time()));
    }
