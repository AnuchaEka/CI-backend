                            ...
                            <div class="pull-right">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        <td>
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" name="del[]" class="checkboxes" value="{{$val['pages_id']}}" />
                                                <span></span>
                                            </label>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                         @if($val['active']==0)     
                                        <a href="{{base_url('mt-admin/'.$uri->segment(2).'/status/'.$val['pages_id'].'?status=1')}}" ><i class="fa fa-check  fa-2x text-success"></i></a>
                                        @else
                                        <a href="{{base_url('mt-admin/'.$uri->segment(2).'/status/'.$val['pages_id'].'?status=0')}}" ><i class="fa fa-times  fa-2x text-danger"></i></a>
                                        @endif
