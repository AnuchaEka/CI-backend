                            ...
                            <div class="pull-right">
                                ...
                                <tbody>
                                    ...
                                    <tr >
                                        <td>
                                            <label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
                                                <input type="checkbox" name="del[]" class="checkboxes" value="{{$val['product_id']}}" />
                                                <span></span>
                                            </label>
                                        </td>
                                        <td>
                                            <a href="{{base_url('mt-admin/'.$uri->segment(2).'/edit/'.$val['product_id'])}}"> {{$val['product_name_'.$session->userdata('configlang')]}} </a> @if($val['product_status']=='Draft') <strong>-- {{$web->getLable('save_draft')}}</strong> @endif
                                        ...
                                        <td>
                                         @if($val['product_active']==0)     
                                        <a href="{{base_url('mt-admin/'.$uri->segment(2).'/status/'.$val['product_id'].'?status=1')}}" ><i class="fa fa-check  fa-2x text-success"></i></a>
                                        @else
                                        <a href="{{base_url('mt-admin/'.$uri->segment(2).'/status/'.$val['product_id'].'?status=0')}}" ><i class="fa fa-times  fa-2x text-danger"></i></a>
                                        @endif
